...
//          from: currentIndex, paragraphs: content.bodyModel.paragraphs)
...
//      attributedText = parseMarkups(
//        text: text, markups: paragraph.markups, isHighlighted: isHighlighted)
//    }
//
//    return ParsedParagraph(
//      original: paragraph, attributedText: attributedText, isHighlighted: isHighlighted)
//  }
//
//  private func parseMarkups(text: String, markups: [Markup], isHighlighted: Bool)
//    -> AttributedString
//  {
...
//          attributedString.startIndex, offsetByUTF8: markup.start),
...
//      switch markup.type {
//      case .strong:
//        attributedString[range].font = .init(
//          FontType.boldSystemFont(ofSize: FontType.systemFontSize))
//      case .em:
//        #if canImport(UIKit)
//          attributedString[range].font = .init(
//            FontType.italicSystemFont(ofSize: FontType.systemFontSize))
//        #else
//          attributedString[range].font = .init(
//            FontType.systemFont(ofSize: FontType.systemFontSize, weight: .regular))
//        #endif
//      case .link:
...
//        #if canImport(UIKit)
//          attributedString[range].font = .init(
//            FontType.monospacedSystemFont(ofSize: FontType.systemFontSize, weight: .regular))
//        #else
//          attributedString[range].font = .init(
//            FontType.monospacedDigitSystemFont(ofSize: FontType.systemFontSize, weight: .regular))
//        #endif
...
//  private func processListParagraphs(from index: Int, paragraphs: [Paragraph]) -> (
//    [ParsedParagraph], Int
//  ) {
...
//      if paragraph.type == .image
//        && (paragraph.layout == .outsetRow || paragraph.layout == .outsetRowContinue)
//      {
//        let parsedParagraph = parseSingleParagraph(paragraph)
...
//  }
//
//  private func processCodeBlock(from index: Int, paragraphs: [Paragraph]) -> (
//    [ParsedParagraph], Int
//  ) {
