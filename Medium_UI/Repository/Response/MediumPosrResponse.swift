...
struct Post: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case id, readingTime, creator, isLocked, firstPublishedAt, latestPublishedVersion, title, visibility, postResponses, clapCount, viewerEdge, detectedLanguage
        case mediumURL = "mediumUrl"
        case updatedAt, allowResponses, isProxyPost, isSeries, previewImage, inResponseToPostResult, inResponseToMediaResource, inResponseToEntityType
        case canonicalURL = "canonicalUrl"
        case previewContent, pinnedByCreatorAt, linkMetadataList, highlights, responsesLocked, tags, content
    }
}
